...
\usepackage{amsmath,amsfonts,amssymb,amscd,amsbsy,amsthm,mathtools,textcomp,stackrel}
\usepackage{xfrac}
\usepackage{bm}
\usepackage{esint}
...
\DeclarePairedDelimiterX\setst[2]{\lbrace}{\rbrace}{\,#1 \;\delimsize\vert\; #2\,}
